...
function IntroButons() {
  const sites = [
    { name: 'Site 1', url: 'https://6oano.beieducacaopedagogico.com/' },
    { name: 'Site 2', url: 'https://6oano-2.beieducacaopedagogico.com/' },
    { name: 'Site 4', url: 'https://6oano-4.beieducacaopedagogico.com/' }
  ];
